      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex-shrink-0">
            <Link href="/" className="text-2xl font-bold text-[#00684D]">
              EventBooking
            </Link>
          </div>
          ...
          <div className="items-center space-x-4">
            {user ? (
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  <span className="w-7 h-7 rounded-full bg-[#00684D] text-white flex items-center justify-center text-sm font-bold">
              ...
              <>
                <Link href="/login" className="text-[#00684D] border border-[#00684D] px-4 py-2 rounded-lg font-medium hover:bg-indigo-50 transition">
                  Login
                </Link>
                <Link href="/register" className="bg-[#00684D] text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-700 transition">
                  Register
                </Link>
              </>
            )}
